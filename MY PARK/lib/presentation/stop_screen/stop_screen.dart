...
class StopScreen extends GetWidget<StopController> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!controller
          .isTimerRunning) { // You might need to add this property in your controller
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                controller.resetTimer(); // Reset the timer. Replace with your actual reset method
                Navigator.of(context).pop(); // Dismiss the dialog
                Get.toNamed(AppRoutes.summaryScreen); // Navigate to the summary screen
              },
            ),
          ],
        );
