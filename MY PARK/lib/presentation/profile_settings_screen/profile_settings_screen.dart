                      ...
                      children: [
                        Container(
                            ...
                            child: CustomImageView(
                                imagePath: ImageConstant.imgContrastErrorcontainer,
                                height: 72.adaptSize,
                                width: 72.adaptSize,
  ...
  Widget _buildForm2FillPhoneNumber() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          SizedBox(height: 4.v),
          Text("No plat".tr.toUpperCase(),
              style: theme.textTheme.bodySmall),
          SizedBox(height: 14.v),
          Text("your plate".tr, style: theme.textTheme.bodyLarge),
          SizedBox(height: 6.v),
          Divider()
        ],
      ),
