          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MapsScreen()), // Replace 'MapsScreen' with the actual name of your maps screen
                );
              },
              child: Container(
                ...
                child: ClipRRect( // Clip it with the same border radius as the container
                  borderRadius: BorderRadius.circular(8),
                  child: Image.asset(
            ...
            Expanded(
              child: GridView.count(
                ...
                crossAxisSpacing: 16,
                children: [
                  _buildMenuOption(Icons.directions_car, 'CAR PLATE', controller.onTapCarPlat,),
                  _buildMenuOption(Icons.play_arrow, 'START/STOP', controller.onTapStartStop),
                  _buildMenuOption(Icons.receipt, 'RECEIPT', controller.onTapReceipt),
                  _buildMenuOption(Icons.history, 'HISTORY', controller.onTapHistory),
                ],
              ),
            ),
          ],
